...
class gz::sim::systems::MulticopterMotorModelPrivate
{
  ...
  // add ROS2 node for publishing motor thrust and an executor for spinning the node in a separate thread
  public: rclcpp::Node::SharedPtr rosNode;
  public: rclcpp::executors::SingleThreadedExecutor::SharedPtr executor;
  public: std::thread rosSpinThread;
